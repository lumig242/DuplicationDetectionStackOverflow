...
2. How to run your code. 
	...
	1. Download pickle-formatted data files from google drive, and extract it to the same directory as main.py
...
5. Potential sources: If large parts of your code were taken from or copied from elsewhere (which is OK but needs to be cited or referenced), include a list of what parts were taken from where. 
